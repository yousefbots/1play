...
.addField('     **(1)-1play** ' ,' **تفتح موسيقي** ')
.addField('     **(2)-1skip**  ' ,' **تحول للاغنيه البعدها** ')
.addField('     **(3)-1stop** ' , '**تخرج البوت من الروم**') 
.addField('     **(4)-1pause** ' , '**ايقاف الاغنيه**') 
.addField('     **(5)-1resume** ' ,' ** تشغيل الاغنيه** ')
.addField('     **(6)-1vol** ' ,' ** تعلي او توطي الصوت** ')
.setColor('#ff0004')
...
client.user.setGame(`1play | crown server`,"http://twitch.tv/crown server")
